...
run the workshops using a local LLM). If you want to run the notebooks locally, you will have to run them
from your locally. You will need the following required tools:
